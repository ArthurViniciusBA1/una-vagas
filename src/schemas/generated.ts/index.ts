...
export const CertificacaoScalarFieldEnumSchema = z.enum(['id','nome','organizacaoEmissora','dataEmissao','dataExpiracao','credencialId','credencialUrl','curriculoId']);
...
export const TipoVagaSchema = z.enum(['ESTAGIO','EFETIVO_JR','TRAINEE','TEMPORARIO','PROJETO']);
